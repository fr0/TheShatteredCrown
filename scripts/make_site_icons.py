...
def make_keep():
    img, d = canvas()
    # curtain wall with crenellated top
    poly(d, [(0.16, 0.82), (0.16, 0.46), (0.22, 0.46), (0.22, 0.40),
             (0.28, 0.40), (0.28, 0.46), (0.36, 0.46), (0.36, 0.40),
             (0.42, 0.40), (0.42, 0.46), (0.58, 0.46), (0.58, 0.40),
             (0.64, 0.40), (0.64, 0.46), (0.72, 0.46), (0.72, 0.40),
             (0.78, 0.40), (0.78, 0.46), (0.84, 0.46), (0.84, 0.82)])
    # central tower rising behind the wall
    poly(d, [(0.40, 0.46), (0.40, 0.24), (0.45, 0.24), (0.45, 0.18),
             (0.50, 0.18), (0.50, 0.24), (0.55, 0.24), (0.55, 0.18),
             (0.60, 0.18), (0.60, 0.46)])
    # banner on the tower
    line(d, [(0.50, 0.18), (0.50, 0.08)])
    poly(d, [(0.50, 0.08), (0.62, 0.11), (0.50, 0.15)], fill=DARK)
    # iron-strapped gate
    poly(d, [(0.44, 0.82), (0.44, 0.62), (0.50, 0.56), (0.56, 0.62), (0.56, 0.82)], fill=DARK)
    save(img, "TSC_SiteKeep")
