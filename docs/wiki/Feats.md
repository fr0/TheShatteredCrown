...
One feat at character level 3 and every third level after. General feats are open to anyone; class feats require the listed class level and modify that class's abilities.
